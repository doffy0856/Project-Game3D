...
export (String, FILE) var ubu_scene
...
func _ready():
	...
	$Level_Select_Menu/Button_Level_UBU.connect("pressed", self, "level_select_menu_button_pressed", ["ubu_scene"])
...
func level_select_menu_button_pressed(button_name):
	...
	elif button_name == "ubu_scene":
		set_mouse_and_joypad_sensitivity()
		get_tree().change_scene("ubu.tscn")
